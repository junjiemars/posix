...
void test_unused(__attribute__((unused)) int a) {
  __attribute__((unused)) int b;
  /* void */
}

__attribute__((unused)) void test_unused_fn(void) { /* void */ }

void test_fallthrough(int a) {
  switch (a) {
  case 0:
...
void test_restrict(__attribute__((unused)) const int *restrict ii,
...
#define _ndef_test_generic_(x) generic((x), int : 1, double : 2, default : 'a')

  __attribute__((unused)) int i = 0;
  __attribute__((unused)) double d = 0.1;
  __attribute__((unused)) char a[] = {0};
...
void test_str(void) { assert(sizeof(_str_(0600)) == 5); }
